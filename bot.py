...
def main_menu_kb(user_id: int | None = None) -> ReplyKeyboardMarkup:
    keyboard = [
        ...
        [KeyboardButton(text="لیست پنل ها"), KeyboardButton(text="پنل های موجود:")],
    ]
    if user_id is not None and user_id in config.ADMIN_IDS:
        keyboard.append([KeyboardButton(text="🛠 کنترل ربات")])
    return ReplyKeyboardMarkup(keyboard=keyboard, resize_رkeyboard=True)
